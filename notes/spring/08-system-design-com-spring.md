...
Para o outro lado do problema, quando o objetivo é fazer uma API só aguentar muita carga (banco, cache, escala horizontal, teste de carga), veja [Escalando uma API para Alta Carga](/labs/java/spring/12-escalando-para-alta-carga/).
